...
abstract class BaseCharacterPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Power', 'PowerOnePerGame', 'Drawback', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'power', 'powerOnePerGame', 'drawback', ),
        BasePeer::TYPE_COLNAME => array (CharacterPeer::ID, CharacterPeer::NAME, CharacterPeer::POWER, CharacterPeer::POWER_ONE_PER_GAME, CharacterPeer::DRAWBACK, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'POWER', 'POWER_ONE_PER_GAME', 'DRAWBACK', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'power', 'power_one_per_game', 'drawback', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Power' => 2, 'PowerOnePerGame' => 3, 'Drawback' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'power' => 2, 'powerOnePerGame' => 3, 'drawback' => 4, ),
        BasePeer::TYPE_COLNAME => array (CharacterPeer::ID => 0, CharacterPeer::NAME => 1, CharacterPeer::POWER => 2, CharacterPeer::POWER_ONE_PER_GAME => 3, CharacterPeer::DRAWBACK => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'POWER' => 2, 'POWER_ONE_PER_GAME' => 3, 'DRAWBACK' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'power' => 2, 'power_one_per_game' => 3, 'drawback' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
